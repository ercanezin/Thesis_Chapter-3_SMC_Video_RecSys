...
class RatingsPredictor(object):
    # user= user line in the matrix, n_rec= number of recommendation requested
    ...
    def calculate_means(self, ur_matrix):
        means = []
    ...
    def pearson_coefficient(self,su, sv):
        num = 0
        denu = 0
        denv = 0
    ...
    def predict_pearson_rating(self, user_rating, ur_matrix, pearson_coefficients):
